...
To build the final jar and optimize the AbsaUGDTMicroBillsSvc application for production, run:
...
Then navigate to [http://localhost:9097](http://localhost:9097) in your browser.
